...
const DrawerNavigator = () => (
  <Drawer.Navigator initialRouteName="Profile" drawerContent={CurstomDrawerContent} screenOptions={{
    ...
    <Drawer.Screen 
      ...
      options={{ drawerLabel: 'Мой Кабинет',
    ...
    <Drawer.Screen 
      ...
      options={{ drawerLabel: 'Транзакции', drawerIcon: ({ size, color }) => (
    ...
    <Drawer.Screen 
      ...
      options={{ drawerLabel: 'Тесты' , drawerIcon: ({ size, color }) => (
